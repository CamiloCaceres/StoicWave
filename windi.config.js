...
export default defineConfig({
  ...
  shortcuts:{
    ...
    'btn-primary': 'border-t-gray-200 border-l-gray-200 border-r-gray-500 border-b-gray-500 focus:(border-b-gray-200 border-r-gray-200 border-l-gray-500 border-t-gray-500) hover:(bg-pink-300)',
